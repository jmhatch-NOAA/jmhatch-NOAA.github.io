...
angular.module('seaturtleApp')
		...
		.controller('ProgressCtrl', function ($scope) {
			...
			$scope.milestones = [{
				task: "1.1", date: "06/2018", milestone: "Meet with GARFO to coordinate on joint GARFO-NEFSC efforts to create rasters of commercial fishing effort.", percent: 0, type: "info" 
			}, {
				...
				task: "3.1", date: "07/2018", milestone: "Complete R Shiny application for track reconstruction using a CTCRW model as described in Winton et al. (2018).", percent: 0, type: "info" 
			}, {
				task: "3.2", date: "12/2018", milestone: "Using the developed R Shiny app, filter 166 satellite tags deployed on large juvnile and adult loggerheads from 2009-2017.", percent: 0, type: "info" 				
			}, {
